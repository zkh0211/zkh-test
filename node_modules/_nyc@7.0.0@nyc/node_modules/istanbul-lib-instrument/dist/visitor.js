...
var VisitState = function () {
    ...
    _createClass(VisitState, [{
        ...
        value: function getBranchIncrement(node, branchName) {
            var index = this.cov.addBranchPath(branchName, node.loc || {
        ...
        value: function insertBranchCounter(path, branchName) {
            var increment = this.getBranchIncrement(path.node, branchName);
            this.insertCounter(path, increment);
        }
    }, {
        key: 'findLeaves',
...
function coverSwitchCase(path) {
    ...
    var increment = this.getBranchIncrement(path.node, b);
...
function coverLogicalExpression(path) {
    ...
    for (var i = 0; i < leaves.length; i += 1) {
        ...
        var increment = this.getBranchIncrement(leaf.node, b);
        if (!increment) {
            continue;
        }

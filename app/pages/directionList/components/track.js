...
export default class Track extends Component{
    ...
    search(){
           //轨迹预警
           this.props.dispatch(policePeopleList({dataTypeCode:this.state.dataTypeCode,dataSourceCode:this.state.dataSourceCode,"policeStation": this.state.deptName,"type":'3',"pageNum":this.state.currentPage,"pageSize":this.state.pageSize},(res)=>{
            if(res.data){
                this.setState({
                    guijiData: res.data,

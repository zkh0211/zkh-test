...
export default class ZxDataOverview extends Component{
    constructor(props){
        super(props);
        this.state={
            // orderByYear:{sum:'',than:''},
            // orderByMonth:{sum:'',than:''},
            // orderByWeek:{sum:'',than:''},
    ...
    renderCanvas(x){
        let length = x*280*this.state.windowWidth;
        let canvas = this.refs.canvas;
        let ctx = canvas.getContext('2d');
        ctx.beginPath();
        ctx.fillStyle='#ffffff';
        ctx.fillRect(0,0,280*this.state.windowWidth,50*this.state.windowHeight);
        ctx.closePath();
        ctx.fillStyle='#f0f2f5';
        ctx.fillRect(0,20*this.state.windowHeight,280*this.state.windowWidth,12*this.state.windowHeight);
        ...
        return(
            <div className="master-content-data">
                <div className="master-text-top">
                    <div className="master-text-top-item">
                        <p>本年任务总量</p>
                    ...
                    <div className="master-text-top-item">
                        ...
                        <div className="master-tubiao">
                            <Chart data={this.state.currentMonthData}  scale={this.state.currentMonthCols} height={40*this.state.windowHeight}  width={280*this.state.windowWidth} padding={[0,0,0,0]}>
                    ...
                    <div className="master-text-top-item">
                        ...
                        <div className="master-tubiao">
                            <Chart data={this.state.currentWeekData}  height={40*this.state.windowHeight}  width={280*this.state.windowWidth} padding={[0,0,0,0]}>
                                <Axis name="year" visible={false}/>
                    ...
                    <div className="master-text-top-item">
                        ...
                        <div className="master-tubiao">
                           <canvas width={280*this.state.windowWidth} height={50*this.state.windowHeight} ref='canvas'></canvas>
                        </div>
                    </div>

...
export default class ChartBarMan extends Component {
    ...
    initOption(newProps) {
        ...
        if (newProps.data.length != 0) {
            this.option.xAxis.max = newProps.data[0]['sl'];
            this.option.series[0].symbolBoundingData = newProps.data[0]['sl'];
            this.option.series[1].symbolBoundingData = newProps.data[0]['sl'];

                ...
                <div className='inner'>
                                        ...
                                        <Carousel {...settings}>
                                        {
                                            this.state.caseFileList.map((item, index) => {
                                                if (item.fileType === 'png' || item.fileType === 'jpg' ||item.fileType === 'jpeg'   ) {
                                                    return (
                                                        <a href={item.filePath} target='_blank' key={item.fileName+'png'}><div className='trace-files-item' >
                                                    ...
                                                    return (
                                                        <a href={item.filePath}  target="_blank" key={item.fileName+'doc'}><div className='trace-files-item'>
                                                    ...
                                                    return (
                                                        <a href={item.filePath}  target="_blank" key={item.fileName+'xls'}><div className='trace-files-item'>
                                                    ...
                                                    return (
                                                        <a href={item.filePath} target="_blank"  key={item.fileName+'file'}><div className='trace-files-item' >
                        ...
                        <div className="inner-radio">
                                <div className="radio-group">
                                    {this.state.zoneAgentUser.map((item, index) => {
                                        return (<div className="gutter-row" key={'zhipai'+index} style={{backgroundImage:`url(${index === 1 || index === 4 ?GutterRow2:GutterRow})`,backgroundSize:'100% 100%'}}>
                                            <div className="radio-title"><span>{item.zoneName}</span></div>
                                            <ul className="radio-box">
                                                {
                                                    item['agentList'].map((itemChild, index) => {
                                                        return (
                                                            <li key={index+'zhipai'} onClick={(e)=>{
                    ...
                    >
                        <div className="inner-radio">
                            ...
                            <Checkbox.Group onChange={this.checkboxOnChange} className='right checkbox-group' style={{height:'auto',overflow:'hidden'}}>

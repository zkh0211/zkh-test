...
import {Button, Carousel, Checkbox, Modal, message, Table, Radio,Rate, Input} from "antd";
...
export default class SyntheticInfo extends Component {
    ...
    showWordModal = (e) => {
        ...
        this.props.dispatch(getWordReport({id:this.state.id,reportId:reportId}, (res) => {
            if (res.status === 200 && res['data']) {
                this.setState({
                    reportInfo:res.data
                })
    ...
    render() {
        ...
        return (
            ...
            <div className="info-content">
                 ...
                 <div className='inner inner-approve'>
                    ...
                    {/*某某市局合成结果
                    <div className={this.state.isPaichusuo?'display-none':'display-block'}>
                        <div className="appoint-box inner-title">
                            <img src={EditIcon} alt="pic"/>
                            <span>合成结果(**{this.state.isFenju?'分局':'市局'})</span>
                        </div>
                        <div className="inner-table">
                            <table border="1">
                                <tbody>
                    ...
                    >
                        <Radio style={{display:(this.state.deptLevel!=='4'?'':'none')}} value={1}>通过</Radio>
                        <Radio value={2}>驳回</Radio>
                        <Radio value={3}  style={{display:(this.state.deptLevel!=='2'?'':'none')}}>上报</Radio>
                    </RadioGroup>
                    ...
                    onClick={this.approveDone.bind(this)}>确认
                    </button>
